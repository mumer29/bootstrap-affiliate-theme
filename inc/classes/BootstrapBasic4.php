...
if (!class_exists('\\BootstrapBasic4\\BootstrapBasic4')) {
    ...
    class BootstrapBasic4
    {
        ...
        public function enqueueScriptsAndStyles()
        {
            ...
            unset($Theme);
            wp_enqueue_style('bootstrap-affiliate-wp-main', get_stylesheet_uri(), [], $themeVersion);
            ...
            wp_enqueue_style('bootstrap-affiliate-font-awesome5', get_template_directory_uri() . '/assets/fontawesome/css/all.min.css', [], '5.15.4');
            wp_enqueue_style('bootstrap-affiliate-main', get_template_directory_uri() . '/assets/css/main.css', [], $themeVersion);
            ...
            if (Bootstrap4Utilities::hasWidgetBlock('calendar')) {
                ...
                wp_enqueue_style('bootstrap-affiliate-widgetblocks-calendar', get_template_directory_uri() . '/assets/css/widget-blocks/calendar.css', [], $themeVersion);
            }
            ...
            wp_enqueue_script('bootstrap-affiliate-main', get_template_directory_uri() . '/assets/js/main.js', ['jquery'], $themeVersion, true);
        ...
        {
            register_sidebar([
                'name'          => __('Sidebar left', 'bootstrap-affiliate'),
                'id'            => 'sidebar-left',
            ...
            register_sidebar([
                'name'          => __('Sidebar right', 'bootstrap-affiliate'),
                'id'            => 'sidebar-right',
                'before_widget' => '<aside id="%1$s" class="widget %2$s">',
                'after_widget'  => '</aside>',
                'before_title'  => '<h1 class="widget-title">',
            ...
            register_sidebar([
                'name'          => __('Header right', 'bootstrap-affiliate'),
                'id'            => 'header-right',
            ...
            register_sidebar([
                'name'          => __('Navigation bar right', 'bootstrap-affiliate'),
                'id'            => 'navbar-right',
                'before_widget' => '',
                'after_widget'  => '',
                'before_title'  => '',
            ...
            register_sidebar([
                'name'          => __('Footer left', 'bootstrap-affiliate'),
                'id'            => 'footer-left',
                'before_widget' => '<div id="%1$s" class="widget %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h1 class="widget-title">',
            ...
            register_sidebar([
                'name'          => __('Footer right', 'bootstrap-affiliate'),
                'id'            => 'footer-right',
                'before_widget' => '<div id="%1$s" class="widget %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<h1 class="widget-title">',
        ...
        public function themeSetup()
        {
            ...
            load_theme_textdomain('bootstrap-affiliate', get_template_directory() . '/languages');
            ...
            // add support menu
            register_nav_menus([
                'primary' => __('Primary Menu', 'bootstrap-affiliate'),
            ]);
