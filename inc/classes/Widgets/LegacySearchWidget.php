    ...
    class LegacySearchWidget extends \WP_Widget
    {
        ...
        public function __construct()
        {
            parent::__construct(
                    ...
                    __('Bootstrap Legacy Search', 'bootstrap-affiliate'), 
                    ['description' => __('Display Search widget for Bootstrap that can be use in sidebar.', 'bootstrap-affiliate')]
            );
        }// __construct
        ...
        public function form($instance) 
        {
            ...
            // output form
            $output = '<p>';
            $output .= '<label for="' . $this->get_field_id('bootstrapbasic4-legacysearch-widget-title') . '">' . __('Title:', 'bootstrap-affiliate') . '</label>';
            ...
            $output .= '<label for="' . $this->get_field_id('bootstrapbasic4-legacysearch-is_navbar') . '">' . __('Is this search on navigation bar?', 'bootstrap-affiliate') . '</label>';
            $output .= '</p>';
            $output .= '<p>';
            ...
            $output .= '<label for="' . $this->get_field_id('bootstrapbasic4-legacysearch-show_button') . '">' . __('Show search button', 'bootstrap-affiliate') . '</label>';
            $output .= '</p>';
