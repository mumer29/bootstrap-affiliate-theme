...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-view-attachment'); ?>>
    <header class="entry-header">
        ...
        <div class="entry-meta">
            ...
            printf(__('Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span>', 'bootstrap-affiliate'),
            ...
            if (is_array($metadata) && array_key_exists('width', $metadata) && array_key_exists('height', $metadata) && null != $metadata['width'] && null != $metadata['height']) {
                ...
                printf(__('at <a href="%1$s" title="Link to attachment file">%2$s &times; %3$s</a>', 'bootstrap-affiliate'),
            ...
            printf(__('in <a href="%1$s" title="Return to %2$s" rel="gallery">%3$s</a>', 'bootstrap-affiliate'),
            ...
            if (
                ...
                printf(__('(<a href="%1$s" title="Link to attachment file">attachment file</a>)', 'bootstrap-affiliate'),
                    esc_url(wp_get_attachment_url())
                );
            }
        ...
        <div class="row mb-3">
            <div class="nav-previous col-6"><?php previous_image_link(false, __('<span class="meta-nav">&larr;</span> Previous', 'bootstrap-affiliate')); ?></div>
            <div class="nav-next col-6 text-right"><?php next_image_link(false, __('Next <span class="meta-nav">&rarr;</span>', 'bootstrap-affiliate')); ?></div>
    ...
    <div class="entry-content">
        ...
        */
        wp_link_pages([
            'before' => '<div class="page-links">' . __('Pages:', 'bootstrap-affiliate') . ' <ul class="pagination">',
            'after'  => '</ul></div>',
            'separator' => ''
        ]);
        ?> 
