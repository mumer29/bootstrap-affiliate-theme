...
<section id="comments" class="comments-area">
    <?php if (have_comments()) { ?> 
        <h2 class="comments-title">
            ...
            if ('1' == $comments_number) {
                ...
                printf(_x('One comment on &ldquo;%s&rdquo;', 'comments title', 'bootstrap-affiliate'), get_the_title());
            } else {
                printf(
        ...
        <?php if (get_comment_pages_count() > 1 && get_option('page_comments')) { // are there comments to navigate through ?> 
            <h3 class="screen-reader-text sr-only"><?php _e('Comment navigation', 'bootstrap-affiliate'); ?></h3>
            <ul id="comment-nav-above" class="comment-navigation clearfix" role="navigation">
                <li class="nav-previous previous"><?php previous_comments_link(__('&larr; Older Comments', 'bootstrap-affiliate')); ?></li>
                <li class="nav-next next"><?php next_comments_link(__('Newer Comments &rarr;', 'bootstrap-affiliate')); ?></li>
    ...
    if (!comments_open() && '0' != get_comments_number() && post_type_supports(get_post_type(), 'comments')) { ?> 
        <p class="no-comments"><?php _e('Comments are closed.', 'bootstrap-affiliate'); ?></p>
    <?php 
    } //endif; 
    ?> 
        ...
        [
            ...
            'fields' => [
                'author' => '<div class="form-group row">' . 
                            '<label class="col-form-label col-md-2" for="author">' . __('Name', 'bootstrap-affiliate') . ($req ? ' <span class="required">*</span>' : '') . '</label> ' .
                            '<div class="col-md-10">' . 
                ...
                'email'  => '<div class="form-group row">' . 
                            '<label class="col-form-label col-md-2" for="email">' . __('Email', 'bootstrap-affiliate') . ($req ? ' <span class="required">*</span>' : '') . '</label> ' .
                            '<div class="col-md-10">' . 
                ...
                'url'    => '<div class="form-group row">' . 
                            '<label class="col-form-label col-md-2" for="url">' . __('Website', 'bootstrap-affiliate') . '</label> ' .
                            '<div class="col-md-10">' . 
            ...
            'comment_field' => '<div class="form-group row">' . 
                            '<label class="col-form-label col-md-2" for="comment">' . __('Comment', 'bootstrap-affiliate') . '</label> ' . 
                            '<div class="col-md-10">' . 
            ...
            'comment_notes_after' => '<p class="form-text text-muted">' . 
                            ...
                            sprintf(__('You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: %s', 'bootstrap-affiliate'), $comment_allowed_tags) . 
                            '</p>'
        ]
    ); 
